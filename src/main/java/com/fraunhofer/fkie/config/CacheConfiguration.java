package com.fraunhofer.fkie.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.fraunhofer.fkie.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.fraunhofer.fkie.repository.UserRepository.USERS_BY_EMAIL_CACHE);
